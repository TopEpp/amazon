...
@section('scripts')
    ...
    <script>
            $(function(){
                ...
                $("div.table-create").html('<button type="button" style="margin:5px 5px 5px 16px;" class="btn btn-title-custom pull-right" onclick="location.href=\'{!! route('orders.create') !!}\'">สั่งสินค้า</button>');
            });
        </script>
@endsection