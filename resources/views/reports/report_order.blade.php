        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="float-right ml-2">
                        <button  type="button" class="btn btn-block btn-success" id="report_pdf"><i class="icofont-file-pdf"></i></button>
                    </div>
                    <div class="float-right ml-2">
                        <button  type="button" class="btn btn-block btn-success" id="report_excel"><i class="icofont-file-excel"></i></button>
                    </div>
                </div>
                <div class="col-md-12">
